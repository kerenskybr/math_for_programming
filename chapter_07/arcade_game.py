...
class PolygonModel():
    """ Class to draw the asteroids/ship
        When asteroids/ship move, we change x and y
    """
...
class Ship(PolygonModel):
    ...
    def laser_segment(self):
        # Will calculate lasers from dist * cos and dist * sin
        # solving dist, the tan
        dist = 20. * sqrt(2)
...
def to_pixels(x,y):
    # Converting vector space to pixel since pygame
    # start at top left 0,0 and vectors start from center
